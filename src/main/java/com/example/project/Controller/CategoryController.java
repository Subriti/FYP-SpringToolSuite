...
public class CategoryController {
    ...
    public void updateCategory(@PathVariable("CategoryId") int CategoryId, String CategoryName, Type CategoryType) {
    	CategoryService.updateCategory(CategoryId,CategoryName, CategoryType);
    }
}
